...
2. Leggere: leggi attentamente il contenuto da riassumere, analizzandolo per capire i punti chiave, la struttura e l’intento del testo originale.
3. Capire: identifica ciò che è centrale nel testo, gli aspetti che l’utente potrebbe trovare più rilevanti, e decidi la giusta lunghezza e livello di dettaglio per il riassunto. Se necessario, rileggi; se non comprendi qualcosa, chiedi chiarimenti.
